...
exports.CertificatesModule = CertificatesModule = __decorate([
    (0, common_1.Module)({
        providers: [certificates_service_1.CertificatesService, pdf_service_1.PdfService],
        controllers: [certificates_controller_1.CertificatesController],
        exports: [certificates_service_1.CertificatesService, pdf_service_1.PdfService],
    })
], CertificatesModule);
